...
class EmployeetypeMiddleware extends BaseMiddleware {

  constructor(app) {
    super({
      app
    });
    this.permissions = require('./employeetype.policy').permissions;
    // this.$acl = app.acl;
    // this.$acl.addPolicy(require('./employeetype.policy').acl);
  }


  async default (req, res, next) {

    console.log('Employeetype middleware;')
...
module.exports = EmployeetypeMiddleware;
...
class BoatstatusMiddleware extends BaseMiddleware {

  constructor(app) {
    super({
      app
    });
    this.permissions = require('./boatstatus.policy').permissions;
    // this.$acl = app.acl;
    // this.$acl.addPolicy(require('./boatstatus.policy').acl);
  }


  async default (req, res, next) {

    console.log('Boatstatus middleware;')
...
module.exports = BoatstatusMiddleware;
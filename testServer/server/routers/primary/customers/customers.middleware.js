...
class CustomersMiddleware extends BaseMiddleware {

  constructor(app) {
    super({
      app
    });
    this.permissions = require('./customers.policy').permissions;
    // this.$acl = app.acl;
    // this.$acl.addPolicy(require('./customers.policy').acl);
  }


  async default (req, res, next) {

    console.log('Customers middleware;')
...
module.exports = CustomersMiddleware;
...
class EmployeestatusMiddleware extends BaseMiddleware {

  constructor(app) {
    super({
      app
    });
    this.permissions = require('./employeestatus.policy').permissions;
    // this.$acl = app.acl;
    // this.$acl.addPolicy(require('./employeestatus.policy').acl);
  }


  async default (req, res, next) {

    console.log('Employeestatus middleware;')
...
module.exports = EmployeestatusMiddleware;
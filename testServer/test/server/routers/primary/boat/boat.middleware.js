...
class BoatMiddleware extends BaseMiddleware {

  constructor(app) {
    super({
      app
    });
    this.permissions = require('./boat.policy').permissions;
    // this.$acl = app.acl;
    // this.$acl.addPolicy(require('./boat.policy').acl);
  }


  async default (req, res, next) {

    console.log('Boat middleware;')

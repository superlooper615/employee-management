...
class VacationstatusMiddleware extends BaseMiddleware {

  constructor(app) {
    super({
      app
    });
    this.permissions = require('./vacationstatus.policy').permissions;
    // this.$acl = app.acl;
    // this.$acl.addPolicy(require('./vacationstatus.policy').acl);
  }


  async default (req, res, next) {

    console.log('Vacationstatus middleware;')
...
module.exports = VacationstatusMiddleware;
...
class VacationMiddleware extends BaseMiddleware {

  constructor(app) {
    super({
      app
    });
    this.permissions = require('./vacation.policy').permissions;
    // this.$acl = app.acl;
    // this.$acl.addPolicy(require('./vacation.policy').acl);
  }


  async default (req, res, next) {

    console.log('Vacation middleware;')
...
module.exports = VacationMiddleware;
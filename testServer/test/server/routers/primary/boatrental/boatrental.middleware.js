...
class BoatrentalMiddleware extends BaseMiddleware {

  constructor(app) {
    super({
      app
    });
    this.permissions = require('./boatrental.policy').permissions;
    // this.$acl = app.acl;
    // this.$acl.addPolicy(require('./boatrental.policy').acl);
  }


  async default (req, res, next) {

    console.log('Boatrental middleware;')
...
module.exports = BoatrentalMiddleware;
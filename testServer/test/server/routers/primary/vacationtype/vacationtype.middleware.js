...
class VacationtypeMiddleware extends BaseMiddleware {

  constructor(app) {
    super({
      app
    });
    this.permissions = require('./vacationtype.policy').permissions;
    // this.$acl = app.acl;
    // this.$acl.addPolicy(require('./vacationtype.policy').acl);
  }


  async default (req, res, next) {

    console.log('Vacationtype middleware;')
...
module.exports = VacationtypeMiddleware;